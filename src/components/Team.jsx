          ...
          >
            {people.map((person) => (
              <li key={person.name}>
                ...
                <h3 className="mt-6 text-lg text-center font-semibold leading-8 tracking-tight text-gray-900">{person.name}</h3>
                <p className="text-base leading-7 text-center text-gray-600">{person.role}</p>
                <ul role="list" className="justify-center mt-6 flex gap-x-6">
                  <li>
